title "EyPC 2023-II Grupo 2 Proyecto"
	.model small
	.386
	.stack 64
;Macros
...
botonX:
	jmp botonX_1
boton0:
	;Imprimir 0 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,0
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton1:
	;Imprimir 1 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,1
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton2:
	;Imprimir 2 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,2
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton3:
	;Imprimir 3 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,3
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton4:
	;Imprimir 4 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,4
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton5:
	;Imprimir 5 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,5
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton6:
	;Imprimir 6 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,6
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton7:
	;Imprimir 7 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,7
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton8:
	;Imprimir 8 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,8
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
boton9:
	;Imprimir 9 en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,9
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
botonA:
	;Imprimir A en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,61
	sub num_boton,44
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
botonB:
	;Imprimir B en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,62
	sub num_boton,44
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
botonC:
	;Imprimir C en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,63
	sub num_boton,44
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
botonD:
	;Imprimir D en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,64
	sub num_boton,44
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
botonE:
	;Imprimir E en calculadora
	;Se cumplieron todas las condiciones
	mov num_boton,65
	sub num_boton,44
	jmp jmp_lee_oper1 		;Salto a 'jmp_lee_oper1' para procesar el numero
